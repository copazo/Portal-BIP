...
if (!is_callable('smarty_modifier_date_format')) include '/var/www/html/demo.cl/exeBIPdev/tools/smarty/plugins/modifier.date_format.php';
if (!is_callable('smarty_function_math')) include '/var/www/html/demo.cl/exeBIPdev/tools/smarty/plugins/function.math.php';
if (!is_callable('smarty_function_counter')) include '/var/www/html/demo.cl/exeBIPdev/tools/smarty/plugins/function.counter.php';
?>
...
?>
	...
	if(<?php echo $_smarty_tpl->tpl_vars['combination']->value['list'];?>
==22)
	<?php $_smarty_tpl->tpl_vars['precio_tienda'] = new Smarty_variable($_smarty_tpl->tpl_vars['combination']->value['price'], null, null);?>
...
// <![CDATA[
	...
	{
                if(nCuotas.value==1)
                    $('#valcuotas').text(formatCurrency(Math.round((parseInt('<?php echo $_smarty_tpl->getVariable('precio_tienda')->value;?>
')-(parseInt('<?php echo $_smarty_tpl->getVariable('precio_tienda')->value;?>
'))*0.1)/nCuotas.value), currencyFormat, currencySign, currencyBlank));
                if(nCuotas.value==2)
                    $('#valcuotas').text(formatCurrency(Math.round((parseInt('<?php echo $_smarty_tpl->getVariable('precio_tienda')->value;?>
')-(parseInt('<?php echo $_smarty_tpl->getVariable('precio_tienda')->value;?>
'))*0.08)/nCuotas.value), currencyFormat, currencySign, currencyBlank));
                if(nCuotas.value==3)
                    $('#valcuotas').text(formatCurrency(Math.round((parseInt('<?php echo $_smarty_tpl->getVariable('precio_tienda')->value;?>
')-(parseInt('<?php echo $_smarty_tpl->getVariable('precio_tienda')->value;?>
'))*0.06)/nCuotas.value), currencyFormat, currencySign, currencyBlank));
                if(nCuotas.value==4)
                    $('#valcuotas').text(formatCurrency(Math.round((parseInt('<?php echo $_smarty_tpl->getVariable('precio_tienda')->value;?>
')-(parseInt('<?php echo $_smarty_tpl->getVariable('precio_tienda')->value;?>
'))*0.04)/nCuotas.value), currencyFormat, currencySign, currencyBlank));
                if(nCuotas.value==5)
                    $('#valcuotas').text(formatCurrency(Math.round((parseInt('<?php echo $_smarty_tpl->getVariable('precio_tienda')->value;?>
')-(parseInt('<?php echo $_smarty_tpl->getVariable('precio_tienda')->value;?>
'))*0.02)/nCuotas.value), currencyFormat, currencySign, currencyBlank));
                if(nCuotas.value==6)
                    $('#valcuotas').text(formatCurrency(('<?php echo $_smarty_tpl->getVariable('precio_tienda')->value;?>
'/nCuotas.value), currencyFormat, currencySign, currencyBlank));    
        }
	//]]>
</script>
					...
					<?php if ($_smarty_tpl->getVariable('product')->value->specificPrice&&$_smarty_tpl->getVariable('product')->value->specificPrice['reduction']){?>
						...
						<?php if ($_smarty_tpl->getVariable('priceDisplay')->value>=0&&$_smarty_tpl->getVariable('priceDisplay')->value<=2){?>
							<?php if ($_smarty_tpl->getVariable('productPriceWithoutRedution')->value>$_smarty_tpl->getVariable('productPrice')->value){?>
								<span id="old_price_display">Precio Lista: <?php echo Product::convertPrice(array('price'=>$_smarty_tpl->getVariable('productPriceWithoutRedution')->value),$_smarty_tpl);?>
</span>
...
Precio Tienda: <?php echo Product::convertPrice(array('price'=>$_smarty_tpl->getVariable('precio_tienda')->value),$_smarty_tpl);?>
</br>
Precio Contado: <?php echo Product::convertPrice(array('price'=>round($_smarty_tpl->getVariable('precio_tienda')->value-($_smarty_tpl->getVariable('precio_tienda')->value)/10)),$_smarty_tpl);?>
<br>
...
'), currencyFormat, currencySign, currencyBlank));
			...
			<p style="float:left;" id="product_reference" <?php if (isset($_smarty_tpl->getVariable('groups',null,true,false)->value)||!$_smarty_tpl->getVariable('product')->value->reference){?>style="display: none;"<?php }?>><label for="product_reference"><?php echo smartyTranslate(array('s'=>'Reference :'),$_smarty_tpl);?>
