<?php /* Smarty version Smarty-3.0.7, created on 2011-12-20 02:15:22
         compiled from "/var/www/html/demo.cl/exeBIPdev/themes/ps_bip/./../../modules/blockconfigurador/product-listConfigurador.tpl" */ ?>
<?php /*%%SmartyHeaderCode:15106262544ef019eaae07b9-68101842%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'eb00de17f3709f94df28aa9445be0f171bdfec7b' => 
    array (
      0 => '/var/www/html/demo.cl/exeBIPdev/themes/ps_bip/./../../modules/blockconfigurador/product-listConfigurador.tpl',
      1 => 1324350080,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '15106262544ef019eaae07b9-68101842',
  'function' => 
  array (
  ),
...
"<?php }?> /></a>
				<h3><?php if (isset($_smarty_tpl->tpl_vars['product']->value['new'])&&$_smarty_tpl->tpl_vars['product']->value['new']==1){?><span class="new"><?php echo smartyTranslate(array('s'=>'Nuevo'),$_smarty_tpl);?>
...
:</span> <?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['feature']->value['value'],'htmlall','UTF-8');?>
					...
					<?php }?>
				<?php }} ?>
				<li class="lista_atributo">P/N # <?php echo $_smarty_tpl->tpl_vars['product']->value["reference"];?>
 <span style="color:#D0D3D8;">|</span> C&oacute;digo Bip: <?php echo $_smarty_tpl->tpl_vars['product']->value["id_product"];?>
</li>
			...
			<div class="right_block">
				...
				<div>
					<?php if (isset($_smarty_tpl->getVariable('prod_combinations',null,true,false)->value[$_smarty_tpl->tpl_vars['product']->value["id_product"]]["Tiendas"]["price"])){?><span class="s_precio_tiendas" style="display: inline;">Precio Tienda: <?php echo Product::convertPrice(array('price'=>$_smarty_tpl->getVariable('prod_combinations')->value[$_smarty_tpl->tpl_vars['product']->value["id_product"]]["Tiendas"]["price"]),$_smarty_tpl);?>
</span><br /><?php }?>
					<?php if (isset($_smarty_tpl->getVariable('prod_combinations',null,true,false)->value[$_smarty_tpl->tpl_vars['product']->value["id_product"]]["Mall"]["price"])){?><span class="s_precio_mall" style="display: inline;">Precio Mall: <?php echo Product::convertPrice(array('price'=>$_smarty_tpl->getVariable('prod_combinations')->value[$_smarty_tpl->tpl_vars['product']->value["id_product"]]["Mall"]["price"]),$_smarty_tpl);?>
</span><br /><?php }?>
					<?php if (isset($_smarty_tpl->tpl_vars['product']->value['show_price'])&&$_smarty_tpl->tpl_vars['product']->value['show_price']&&!isset($_smarty_tpl->getVariable('restricted_country_mode',null,true,false)->value)){?><span class="price" style="display: inline;" id="precio-lista">Precio de Lista: <?php if (!$_smarty_tpl->getVariable('priceDisplay')->value){?><?php echo Product::convertPrice(array('price'=>$_smarty_tpl->tpl_vars['product']->value['price']),$_smarty_tpl);?>
<?php }else{ ?><?php echo Product::convertPrice(array('price'=>$_smarty_tpl->tpl_vars['product']->value['price_tax_exc']),$_smarty_tpl);?>
<?php }?></span><br /><span class="price" style="display: inline;" id="precio-internet">Precio M&iacute;nimo Internet:<br /><span class="price-internet-valor"> <?php if (!$_smarty_tpl->getVariable('priceDisplay')->value){?><?php echo Product::convertPrice(array('price'=>($_smarty_tpl->tpl_vars['product']->value['price']*0.9)),$_smarty_tpl);?>
<?php }else{ ?><?php echo Product::convertPrice(array('price'=>$_smarty_tpl->tpl_vars['product']->value['price_tax_exc']),$_smarty_tpl);?>
<?php }?></span></span><?php }?>
