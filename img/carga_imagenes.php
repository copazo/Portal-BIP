...
/*	while($tipo=mysql_fetch_array($res_tipos))
	...
	//copy("".$row["id_product"].".jpg","".$row["id_product"]."-".$insert_id_value.".jpg");
                ...
                echo $row['id_category_default']."<br>";
            copy("p/".$row["id_product"]."-home.jpg","c/".$row["id_category_default"]."-category.jpg");
            copy("p/".$row["id_product"]."-home.jpg","c/".$row["id_category_default"].".jpg");
