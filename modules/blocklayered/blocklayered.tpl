...
<div id="layered_block_left" class="block">
	...
	<div class="block_content">
		<form action="#" id="layered_form" name="layered_form">
			<div>
Clean All<input type="checkbox" class="checkbox" name="clean_all_10" id="clean_all_10" value="1" /> 
							...
							{literal}
								addSlider('{/literal}{$filter.type}{literal}',{
									...
									slide: function( event, ui ) {
										$('#layered_{/literal}{$filter.type}{literal}_range').html( formatCurrency(ui.values[ 0 ]) + ' - ' + formatCurrency(ui.values[ 1 ]));
									},
									stop: function () {
										reloadContent();
									}
