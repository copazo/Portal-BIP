...
class LinkConfiguradorCore
{
	...
	public function getCategoryLink($id_category, $alias = NULL, $id_lang = NULL)
	{
		if (is_object($id_category))
			...
			(_PS_BASE_URL_.__PS_BASE_URI__.'modules/blockconfigurador/categoryConfigurador.php?id_category='.(int)($id_category->id));
		if ($alias)
			return ($this->allow == 1) ? (_PS_BASE_URL_.__PS_BASE_URI__.$this->getLangLink((int)($id_lang)).(int)($id_category).'-'.$alias) :
			(_PS_BASE_URL_.__PS_BASE_URI__.'modules/blockconfigurador/categoryConfigurador.php?id_category='.(int)($id_category));
		return _PS_BASE_URL_.__PS_BASE_URI__.'modules/blockconfigurador/categoryConfigurador.php?id_category='.(int)($id_category);
	}
