...
<option value="">Seleccione Cuota</option>
			...
			<p{if ($product->quantity <= 0) OR !$product->available_for_order} style="display: none;"{/if} id="add_to_cart" class="buttons_bottom_block"><input type="submit" name="Submit" value="{l s='Add to cart'}" class="exclusive" /></p>
