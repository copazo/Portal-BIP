...
<!--					<br />-->
					...
					{if $priceDisplay >= 0 && $priceDisplay <= 2}
						<span id="our_price_display_internet" class="label_precio_pdirecta">Precio Transferencia Directa</br><span class="precio_pdirecta">{$product->price_internet}</span></br>
