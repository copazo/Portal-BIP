...
{if $product.condition eq 'used'}
                                        <span class="s_precio_internet" style="display: inline;"><span class="price" style="display: inline;" id="precio-internet">Cheque 30 Días: {convertPrice price=round(($product.price*100)/90)}</span></span><br>
{/if}	
