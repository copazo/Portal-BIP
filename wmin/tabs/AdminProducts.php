					...
					<tr>
						...
						<td style="padding-bottom:5px;">
							...
							<span class="hint" name="help_box">'.$this->l('Special characters allowed:').' .-_#\<span class="hint-pointer">&nbsp;</span></span>
                                        ...
                                        <tr>
						<td class="col-left">Codigo Bip Usado</td>
						<td style="padding-bottom:5px;">
...
<?php
	...
	function displayFormFeatures($obj)
	{
		...
		{
			//$feature = Feature::getFeatures((int)($cookie->id_lang));
                        $feature = Feature::getFeaturesByIdWithout((int)($cookie->id_lang),(int)($obj->id));
...
jQuery(document).ready(function() {
  ...
  jQuery(".heading").click(function()
  {
    jQuery(this).next(".content").slideToggle(500);
			...
			<hr style="width:100%;" /><br /><table style="width:900px;"><tr><th><a href="#" class="heading"><p class="heading">Esconder/Mostrar</p></a></th></tr></table>';
			// Header
			$nb_feature = Feature::nbFeatures((int)($cookie->id_lang));
